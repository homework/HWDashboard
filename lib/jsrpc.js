(function() {
  ...
  JSRPC = (function() {
    var Command, RPCState, idleInboundTimer, idleOutboundTimer, inboundSeqNo, inboundSubPort, lport, outboundSeqNo, outboundSubPort, state;
          ...
          if (seq_no < outboundSeqNo) {
            ...
            switch (command) {
              ...
              case Command.PACK:
                ...
                return console.log("PACK cleared");
            }
          }
    ...
    JSRPC.prototype.setIdleTimer = function(direction, ticks) {
      ...
      if (ticks === 0) {
        ...
        return console.log("Tick timeout");
      } else if (direction === 0) {
