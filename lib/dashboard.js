(function() {
  var DASHBOARD_PORT, Defragger, EventEmitter, HWDBParser, HWDashboardLogger, JSRPC, LOG_LEVEL, Packeteer, express, hwdbparser, io_server, log, now_app, pktr, rest_server, stats_jsrpc;
  ...
  io_server.now.serverOutput = function(data) {
    console.log(data);
    return io_server.now.statsUpdate(50);
  };
  stats_jsrpc.connect();
