(function() {
  ...
  DashORM = (function() {
    function DashORM(socketio_server) {
      this.query = __bind(this.query, this);      this.socketio = socketio_server;
      ...
      this.state_collector = new HWState(this.socketio, __bind(function(state) {
