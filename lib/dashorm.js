(function() {
  ...
  DashORM = (function() {
    ...
    DashORM.prototype.query = function(model, parameters, response) {
      var current_date, date_string, last_update, ma, month_id, month_str, month_totals;
      switch (model) {
        case "allowances":
          ...
          if (current_date.getFullYear() === parseInt(parameters[0]) && (current_date.getMonth() + 1) === parseInt(parameters[1])) {
          ...
          return month_totals.on('end', __bind(function(result) {
            ...
            if (current_date.getFullYear() === parseInt(parameters[0]) && (current_date.getMonth() + 1) === parseInt(parameters[1])) {
              return dashboardModel.monthlyallowances.add(ma);
            }
          }, this));
        case "usage":
