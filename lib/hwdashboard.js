(function() {
  var Aggregator, DASHBOARD_PORT, DashORM, HWDashboardLogger, JSRPC, LOG_LEVEL, dashORM, express, hwdb_query, hwdb_stream, io_server, log, models, package_data, package_timeout, path, rest_server, sio_app;
  LOG_LEVEL = 5;
  DASHBOARD_PORT = 80;
